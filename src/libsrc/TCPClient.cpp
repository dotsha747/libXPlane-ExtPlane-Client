...
#include "XPlaneExtPlaneClient/TCPClient.h"

using namespace std;

XPlaneExtPlaneClient::TCPClient::TCPClient() {
...
void XPlaneExtPlaneClient::TCPClient::mainLoop() {
...
void XPlaneExtPlaneClient::TCPClient::eventTick(time_t _time) {
...
void XPlaneExtPlaneClient::TCPClient::initConnection(time_t _time) {
...
void XPlaneExtPlaneClient::TCPClient::dropConnection(time_t _time) {
...
double XPlaneExtPlaneClient::TCPClient::getHighResolutionTime() {
...
void XPlaneExtPlaneClient::TCPClient::eventRead(time_t _time) {
...
void XPlaneExtPlaneClient::TCPClient::eventWrite(time_t _time) {
...
void XPlaneExtPlaneClient::TCPClient::processInput(time_t _time) {
...
void XPlaneExtPlaneClient::TCPClient::processLine(time_t _time, std::string line) {

	cout << "TCPClient::processline GOT [" << line << "]" << endl;
}

void XPlaneExtPlaneClient::TCPClient::addHost(std::string _host) {

	hostList.push_back(_host);
}

unsigned int XPlaneExtPlaneClient::TCPClient::getHostCount() {

	return hostList.size();
}

void XPlaneExtPlaneClient::TCPClient::sendData(std::string data) {
