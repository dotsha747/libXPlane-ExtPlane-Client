...
src/test/testXPlaneExtPlaneClient: $(TESTOBJS) $(LIBFILE)
#	$(CC) -L . -o $@ src/test/testXPlaneExtPlaneClient.o $(LIBNAME).so
...
install: $(LIBFILE) $(EXE) doc
	...
	install -D src/libsrc/XPlaneExtPlaneClient/Base64.h $(PREFIX)/include/XPlaneExtPlaneClient/Base64.h
	install -D src/libsrc/XPlaneExtPlaneClient/TCPClient.h $(PREFIX)/include/XPlaneExtPlaneClient/TCPClient.h
	install -D src/libsrc/XPlaneExtPlaneClient/ExtPlaneClient.h $(PREFIX)/include/XPlaneExtPlaneClient/ExtPlaneClient.h
